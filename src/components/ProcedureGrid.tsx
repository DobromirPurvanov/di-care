            ...
            <section key={cat.id} className="mb-8 last:mb-0" aria-label={cat.label}>
              <div className="flex items-baseline gap-3 mb-4">
                <span
                  ...
                  style={{ background: 'var(--accent)', boxShadow: '0 0 8px rgba(200,160,94,0.6)' }}
                />
                <h3 className="text-[11px] tracking-[0.22em] uppercase" style={{ color: 'rgba(242,237,226,0.7)' }}>
                  {cat.label}
                </h3>
                ...
                <span
                  ...
                  style={{ background: 'linear-gradient(90deg, rgba(200,160,94,0.25), transparent)' }}
                />
              </div>
