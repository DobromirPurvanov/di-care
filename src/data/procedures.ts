...
const seeds: ProcedureSeed[] = [
  // ── Озонотерапия ──────────────────────────────────────────────
  { title: 'Голяма автохемотерапия', category: 'ozone', description: 'Обогатяване на собствената кръв с медицински озон и връщането ѝ в организма — подпомага оксигенацията, имунитета и възстановителните процеси.' },
  ...
  { title: 'Ректална озонотерапия', category: 'ozone', description: 'Щадящ метод за системно приложение на озон с ефективност, близка до голямата автохемотерапия — особено подходящ за детокс на черния дроб.' },
  ...
  { title: 'Озон за венци', category: 'ozone', description: 'Намалява бактериалното натоварване и подпомага оздравителните процеси на венците и пародонта.' },
  ...
  { title: 'NightLase', category: 'laser', description: 'Неинвазивно лазерно лечение на хъркането чрез стягане на меките тъкани в устната кухина.' },
  ...
  { title: 'TightSculpting', category: 'laser', description: 'Fotona TightSculpting® с HoneyComb скенер — оформяне на тялото и стягане на кожата без операция и възстановяване.' },
  { title: 'Онихомикоза', category: 'laser', description: 'Лазерно лечение на гъбички по ноктите без медикаментозно натоварване на организма.' },
  { title: 'Корекция на уши', category: 'laser', description: 'Минимално инвазивна корекция на разширени или разкъсани ушни лобули.' },
  ...
  { title: 'Керамични корони', category: 'dental', description: 'Високоестетична протетика с керамични корони за естествен вид и здравина.' },
]
